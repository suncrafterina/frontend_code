...
export class ProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    setTimeout(() => {
      this.getProfileData();
      this.profileStatus('shippingvendor');
    }, 500);
  }
  ...
  formInIt() {
    this.profileForm = this.fb.group({
      ...
      first_name: ['', [Validators.required, Validators.minLength(3), Validators.maxLength(25), CustomValidation.validateWhiteSpace]],
      last_name: ['', [Validators.required, Validators.minLength(3), Validators.maxLength(25), CustomValidation.validateWhiteSpace]],
      ...
      billing_address_1: ['', [Validators.minLength(50),Validators.maxLength(200)]],
      billing_address_2: ['', [Validators.minLength(50),Validators.maxLength(200)]],
  ...
  profile() {
    if (this.profileForm.valid) {
      ...
      this.getData.updateUserProfile(postData, this.selectFile, id, this.companySelectFile).subscribe(res => {
        ...
        this.AccountUserData();
        this.router.navigate(['shipping/profile/info']);
      }, error => {
        this._comm.notifyShowHideLoader({ show: false });
