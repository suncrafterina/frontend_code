...
export class ProfileService {
  ...
  getUserData(id:any){
    return this.http.get(environment.apiUrl + 'hytx/shippingvendor/api/profile/'); 
  }
  getPaymentData(){
    return this.http.get(environment.apiUrl + 'hytx/shippingvendor/api/payment-setting'); 
  }
  getCountryList()
  {
  ...
  updateUserProfile(data: any,selectFile:any,id:any,companySelectFile:any)
  {
    ...
    return this.http.put(environment.apiUrl + 'hytx/shippingvendor/api/profile', formData);
  }
  updateUserPayment(data: any)
  {
    return this.http.put(environment.apiUrl + 'hytx/shippingvendor/api/payment-setting', data);
  }
  getOtherData(){
    return this.http.get(environment.apiUrl + 'hytx/shippingvendor/api/other-setting'); 
  }
  updateUserOther(data: any)
  {
    ...
    {
      const postData = data;
      return this.http.put(environment.apiUrl + 'hytx/shippingvendor/api/other-setting', postData);
    }else
    {
  ...
  {
    return this.http.put(environment.apiUrl + 'hytx/shippingvendor/api/other-setting', data);
  }
  getCountries(){
		return this.http.get(environment.apiUrl+'hytx/authuaaserver/api/country',{
			observe: 'response'
