...
export class transactionsService {
	...
	getTransactionList(data: any, params: any){
		return this.http.get(environment.apiUrl + 'hytx/warehousevendor/api/transactions',{
			observe:'response',
	...
	getDownloadTransation(params: any){
		return this.http.get(environment.apiUrl + 'hytx/warehousevendor/api/download-transactions',{
