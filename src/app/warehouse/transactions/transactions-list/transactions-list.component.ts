...
export class TransactionsListComponent implements OnInit {
	...
	displayedColumns: string[] = ['code', 'txn_id', 'customer_name', 'commission_amount', 'warehouse_name','amount','txn_date', 'action'];
	totalRecords: any;
	fetchedRecords = 1;
	startPage = 0;
	endPage = 0;
	...
	{
	  this._comm.notifyShowHideLoader({ show: true });
	  const postData = {user_type:'ROLE_WAREHOUSE_VENDOR',from_to: this.fromDate, to_date: this.toDate };
