...
export class TransactionsComponent implements OnInit {
  ...
  displayedColumns: string[] = ['txn_id','code', 'user_name','user_type','commission_amount','amount','txn_date', 'txn_type'];
  totalRecords: any;
  fetchedRecords = 1;
  startPage = 0;
  endPage = 0;
  ...
  {
    this._comm.notifyShowHideLoader({ show: true });
    const postData = {user_type:'',from_to: this.fromDate, to_date: this.toDate };
