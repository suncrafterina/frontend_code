...
export class SalesService {
  ...
  constructor(private http: HttpClient) { }
	...
	getOrderList(data: any, params: any){
		return this.http.get(environment.apiUrl + 'hytx/admin/api/orders',{
			observe:'response',
	...
	getTransactionList(data: any, params: any){
		return this.http.get(environment.apiUrl + 'hytx/admin/api/transactions',{
			observe:'response',
			params: new HttpParams()
			.set('size', params.pageSize.toString())
			.set('search', params.search)
	...
	getDownloadTransation(params: any){
		return this.http.get(environment.apiUrl + 'hytx/admin/api/download-transactions',{
	...
	{
	  return this.http.get(environment.apiUrl + 'hytx/admin/api/order/'+ id);
	}
