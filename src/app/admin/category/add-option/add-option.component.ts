...
export class AddOptionComponent implements OnInit {
  ...
  constructor(private _category: CategoryService,public translate: TranslateService, private _comm: CommunicationService, private _alrt: AlertService, private router: Router, private _auth: AuthenticationService,private route: ActivatedRoute) {
  ...
  fetchCategoryList() {
		...
		this._category.getOptionList(this.filter, postData,this.subcategoryId).subscribe((data) => {
