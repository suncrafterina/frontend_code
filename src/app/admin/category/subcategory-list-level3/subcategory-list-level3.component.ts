...
@Component({
  selector: 'app-subcategory-list-level3',
  templateUrl: './subcategory-list-level3.component.html',
  styleUrls: ['./subcategory-list-level3.component.css']
})
export class SubcategoryListLevel3Component implements OnInit {
  dataEmpty = true;
  categoryList: any;
  data:[];
  dataList:any;
  ...
  pageTitle: any;
  categoryTitle:any;
  displayedColumns: string[] = ['title','sorting_order','products','action'];
  ...
  fetchCategoryList() {
		...
		this._category.getsubcategoryListLeve3(this.filter, postData,this.subcategoryId).subscribe((data) => {
